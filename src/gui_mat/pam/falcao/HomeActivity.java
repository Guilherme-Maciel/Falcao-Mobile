	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bioMuda.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				...
				Intent it = new Intent(HomeActivity.this, BioActivity.class);
				startActivity(it);
		...
		discoMuda.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				...
				Intent it = new Intent(HomeActivity.this, DiscoActivity.class);
				startActivity(it);
		...
		contatoMuda.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				...
				Intent it = new Intent(HomeActivity.this, ContatoActivity.class);
				startActivity(it);
		...
		agenda.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				...
				Intent it = new Intent(HomeActivity.this, AgendaActivity.class);
				startActivity(it);
			}
		});
		//End Menu buttons.
